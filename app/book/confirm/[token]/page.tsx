...
// Booking backend removed — confirmation links are no longer processed.
        ...
        <Container>
          <div className="mx-auto max-w-md glass rounded-2xl p-8 text-center shadow-2xl">
            ...
            <p className="text-muted-foreground mt-2 mb-8">
              Online booking management is currently disabled. Please get in touch
              and we&apos;ll help sort out your consultation.
            </p>
