...
// Booking backend removed — reschedule links are no longer processed.
        ...
        <Container>
          <div className="mx-auto max-w-md glass rounded-2xl p-8 text-center shadow-2xl">
            ...
            <p className="text-muted-foreground mt-2 mb-8">
              Online booking management is currently disabled. To reschedule a
              consultation, please get in touch and we&apos;ll find a new time.
            </p>
